...
import {getOtherUserFromConnection, Connection, ConnectionType} from "@/types/connections";
...
const ConnectionListItem = ({connection}: ConnectionListItemPreviewProps) => {
    ...
    return (
        ...
        >
            {getAvatarByConnectionType(connection.connectionType, otherUser.avatarUrl)}
...
export function getAvatarByConnectionType(connectionType: ConnectionType, avatarUrl?: string): React.ReactNode {
