...
const SuggestedConnectionItemSkeleton = () => {

    return (
        <div
            className="bg-background-100 hover:bg-background-300 hover:cursor-pointer rounded-lg flex flex-row gap-2 items-center justify-center shrink-0 p-2"
        >
            <Skeleton className="rounded-full object-cover shrink-0 w-16 h-16"/>
...
export default SuggestedConnectionItemSkeleton;