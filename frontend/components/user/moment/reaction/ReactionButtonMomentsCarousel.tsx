...
import { Moment, ReactionType } from "@/types/moment";
...
const ReactionButtonMomentsCarousel = ({isDelaying, currentMoment}: ReactionButtonProps) => {
    ...
    const debouncedToggleReaction = useDebouncedCallback(
        async (momentId: string, reactionType: ReactionType | null, currentReaction: ReactionType | null) => {
            ...
            const result = await toggleReaction(momentId, reactionType);
            if (result.success) {
...
export default ReactionButtonMomentsCarousel;
